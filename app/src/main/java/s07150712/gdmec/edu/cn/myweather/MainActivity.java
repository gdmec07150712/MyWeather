package s07150712.gdmec.edu.cn.myweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initChooseDialog(){
        choose_dialog=new AlertDialog.Builder(seft).setTitle("选择城市").setPositiveButton("确定",new
                ChooseCityListener()).setNegativeButton("取消",null).create();
        ...
        final ArrayAdapter<String> provinceAdapter = new ArrayAdapter<String>(this,R.layout.simple_list_item,
    ...
    public class ChooseCityListener implements DialogInterface.OnClickListener{
        @Override
